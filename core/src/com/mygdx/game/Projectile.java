...
public class Projectile extends Actor {
    ...
    public enum ProjectileState {FIRING, EXPLODING, RESET,IDLE}
...
//    }
    ...
    public void setMovementSpeedX(float movementSpeedX) {
    ...
    public void setMovementSpeedY(float movementSpeedY) {
